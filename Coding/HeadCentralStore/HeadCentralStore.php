...
<div class="container">
    ...
    <div class="jumbotron"><h3><a href="HeadCentralStore.php">HEAD OF CENTRAL STORE</a></h3></div>

</div>

<div class="left-box">
<ul>
      <li>  <a href="RetailStoreRequest.php"><h3> Check Retail Store Requests</h3></a></li>
     <li> <a href="PurchaseOrderRequest.php"><h3>Check Purchase Order Requests </h3></a></li>
      </ul>
</div>
