...
<div class="container">
    ...
    <div class="jumbotron"><h3><a href="RetailStoreManager.php">Retail Store Manager</a></h3></div>

</div>

<div class="left-box">
<ul>
     <li> <a href="RetailPurchaseOrder.php" ><h3>Purchase Order</h3></a></li>
      <li><a href="MIReport.php" ><h3>MI Report</h3></a></li>
      </ul>
</div>
